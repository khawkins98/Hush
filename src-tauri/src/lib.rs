...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::commands::get_sound_cue_start_enabled,
            ipc::commands::set_sound_cue_start_enabled,
            ipc::commands::get_sound_cue_complete_enabled,
            ipc::commands::set_sound_cue_complete_enabled,
